...
def get_argparse():
    ...
    parser.add_argument('--score', type=str, default="HYBRID", choices=["MSE", "MAHALA", "LATENT", "HYBRID"])
    ...
    parser.add_argument('--grad_clip', default=5.0, type=float,
                        help='maximum gradient norm. set <=0 to disable')
    parser.add_argument('--hidden_dim', default=512, type=int,
                        help='hidden dimension for the autoencoder')
    parser.add_argument('--latent_dim', default=64, type=int,
                        help='latent dimension for the autoencoder')
    parser.add_argument('--dropout', default=0.1, type=float,
                        help='dropout ratio for the autoencoder')
    parser.add_argument('--input_noise', default=0.05, type=float,
                        help='relative Gaussian corruption for denoising training')
    parser.add_argument('--latent_loss_weight', default=0.01, type=float,
                        help='weight for latent compactness regularization')
    parser.add_argument('--hybrid_recon_weight', default=0.6, type=float,
                        help='reconstruction-score weight in HYBRID mode')
    parser.add_argument('--hybrid_latent_weight', default=0.4, type=float,
                        help='latent-score weight in HYBRID mode')
    parser.add_argument('--file_score_quantile', default=0.9, type=float,
                        help='upper frame-score quantile used for file-level anomaly score')
    parser.add_argument('--file_score_tail_weight', default=0.5, type=float,
                        help='weight for the upper-tail file score aggregation')
    parser.add_argument('--cov_eps', default=1e-4, type=float,
                        help='diagonal loading for covariance inverses')
