...
class BaseModel(object):
    ...
    def calc_decision_threshold(self, score_distr_file_path=None):
        ...
        if isinstance(params, dict) and params.get("kind") == "empirical_quantile":
            return float(np.quantile(params["scores"], self.args.decision_threshold))
